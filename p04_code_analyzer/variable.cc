...
Variable::Variable(std::string tipo, std::string nombre, int linea, bool inicializada)
    : tipo_(std::move(tipo)), nombre_(std::move(nombre)), linea_(linea), inicializada_(inicializada) {}
